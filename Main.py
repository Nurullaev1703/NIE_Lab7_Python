...
class Form2(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.tableWidget.itemClicked.connect(
            lambda:self.onClicked(self.tableWidget)
        )
        ...
        self.onClicked(self.tableWidget)


    def onClicked(self, tableWidget):
        answers[0] = tableWidget.item(tableWidget.currentRow(),0).text()
        self.label_selected.setText('Выбрано: ' + str(answers[0]))
...
class Form3(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.btn_back.clicked.connect(self.back)
        self.btn_next.clicked.connect(self.next)
        self.radioButton_1.toggled.connect(lambda: self.onToggled(self.radioButton_1))
        self.radioButton_2.toggled.connect(lambda: self.onToggled(self.radioButton_2))
        self.radioButton_3.toggled.connect(lambda: self.onToggled(self.radioButton_3))
        self.radioButton_4.toggled.connect(lambda: self.onToggled(self.radioButton_4))
...
class Form4(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.checkBox_1.toggled.connect(lambda: self.onToggled(self.checkBox_1))
        self.checkBox_2.toggled.connect(lambda: self.onToggled(self.checkBox_2))
        self.checkBox_3.toggled.connect(lambda: self.onToggled(self.checkBox_3))
        self.checkBox_4.toggled.connect(lambda: self.onToggled(self.checkBox_4))
